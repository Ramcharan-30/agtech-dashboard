...
const Register = () => {
  ...
  useEffect(() => {
    ...
    if (GOOGLE_CLIENT_ID && window.google && btnEl) {
    ...
    <div className="auth-page">
      ...
      <div className="auth-container animate-scale-in">
        ...
        <div className="auth-logo">
          ...
          <span className="sidebar-logo-text">AgTech Intel</span>
        </div>

        <h1 className="auth-title">Create your account</h1>
        <p className="auth-subtitle">Get started with market intelligence</p>

        {error && <div className="error-alert animate-scale-in">{error}</div>}
